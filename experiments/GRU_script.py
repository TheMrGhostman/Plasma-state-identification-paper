...
from utils.my_blocks import GRU_CLF
...
#4) model
f = GRU_CLF(5, 32, 2, 0, 64, 4, get_activation(options.activation))
...
#7) model name
model_name = f"GRU_lr={options.lr}_bs={options.batch_size}_scheduler={options.scheduler}_ui={options.ui}"
